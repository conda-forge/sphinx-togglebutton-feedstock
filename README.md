...
Once the `conda-forge` channel has been enabled, `sphinx-togglebutton` can be installed with:

```
conda install sphinx-togglebutton
```

It is possible to list all of the versions of `sphinx-togglebutton` available on your platform with:
